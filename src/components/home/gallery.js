      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 grid-rows-6 gap-2 md:grid-cols-3 md:grid-rows-4 xl:grid-cols-3 xl:grid-rows-4 xl:h-[90vh] md:h-[75vh] h-[90vh]">
          ...
          viewport={{ once: true, amount: 0.3 }}
            whileInView={{ y: 0 , opacity:1 }}
            transition={{ delay: 0.4, duration: 0.4 }}
            className="row-span-2 col-start-2 row-start-3 min-h-24 rounded-lg  flex items-center justify-center bg-slate-300 md:row-span-2 md:col-start-3 md:row-start-2 xl:col-start-1 xl:row-start-3 xl:row-end-3"
          >
            <Image
              src="/gallery/7.jpg"
              alt="image"
